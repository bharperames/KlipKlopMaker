...
/**
 * BED CONTACT IS A QUESTION ABOUT ISLANDS, NOT ABOUT AREA — `bedStability`
 * above sums downward faces, and a total passes a first layer that is three
 * separate crescents each holding its own tower down alone (the collet
 * spaghetti). The two measurements coexist because area is cheap and islands
 * are the truth; WHERE THEY DISAGREE, ISLANDS WIN. Moved here from
 * scripts/first_layer.mjs so the app can gate on it too, not only the
 * offline scripts.
 */
/**
